...
class ControllerCheckoutCart extends Controller {
	...
	public function addAll() {
		...
		if (isset($this->request->post['orders'])) {
			$orders = json_decode(html_entity_decode($this->request->post['orders']), true);
		} else {
			$orders = array();
		}
		...
		$json['success'] = sprintf($this->language->get('text_success'), $this->url->link('common/home'), '', $this->url->link('checkout/cart'));
